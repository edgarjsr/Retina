...
class ErrorDeTipo < ContextError
  ...
  def to_s
    "Error línea #{@linea} y columna #{@columna}: operacion #{@operacion} no definida entre  \"#{@tipo_izq}\" y \"#{@tipo_der}\""
  end
end
...
class ErrorDeTipoUnario < ContextError
  ...
  def to_s
    "Error línea #{@linea} y columna #{@columna}: operacion #{@operacion}  no definida para  \"#{@tipo}\""
  end
end
...
class NoDeclarada < ContextError
  ...
  def to_s
    "Error #{@linea} y columna #{@columna}: la variable \"#{@nombre}\" no se encuentra declarada"
  end
end
